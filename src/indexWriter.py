...
class IndexHtmlWriter(writer.HtmlWriter):
	...
	def writeContents(self,makeFns):
		...
		w(
			...
			"Позже в этом формате в разделе "+a("http://www.fincom.spb.ru/comfin/budjet/budget_for_people.htm","«Бюджет для граждан»")+" был опубликован проект закона, закон и 1-е изменения к закону о бюджете на 2014 года (но не был опубликован проект 1-х изменений).</p>\n"
		)
		w("<table>\n")
		w("<thead>\n")
